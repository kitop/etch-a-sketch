...
var _user$project$Main$shakeAnimation___ = function (t) {
	return A2(
...
var _user$project$Main$shakeAnimation__ = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		200 * _elm_lang$core$Time$millisecond,
		A2(
...
var _user$project$Main$shakeAnimation_ = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		200 * _elm_lang$core$Time$millisecond,
		A2(
...
var _user$project$Main$shakeAnimation = function (t) {
	return A2(
		_mgold$elm_animation$Animation$duration,
		200 * _elm_lang$core$Time$millisecond,
		A2(
...
var _user$project$Main$animations = {
	ctor: '::',
	_0: _user$project$Main$shakeAnimation,
	_1: {
		ctor: '::',
		_0: _user$project$Main$shakeAnimation_,
		_1: {
			ctor: '::',
			_0: _user$project$Main$shakeAnimation__,
			_1: {
				ctor: '::',
				_0: _user$project$Main$shakeAnimation___,
				_1: {ctor: '[]'}
			}
		}
	}
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'KeyboardExtraMsg':
				var keyboardState = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p0._0, model.keyboardState);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'Tick':
				var _p1 = function () {
					var _p2 = A2(_mgold$elm_animation$Animation$isDone, model.clock, model.animation);
					if (_p2 === true) {
						...
						var nextAnimation = function () {
							var _p3 = _elm_lang$core$List$head(model.animations);
							if (_p3.ctor === 'Just') {
								return _p3._0(model.clock);
							} else {
								return _mgold$elm_animation$Animation$static(0);
							}
						}();
						var justFinished = _elm_lang$core$Native_Utils.eq(
							nextAnimation,
							_mgold$elm_animation$Animation$static(0)) && (!_elm_lang$core$Native_Utils.eq(
							model.animation,
							_mgold$elm_animation$Animation$static(0)));
						var nextPoints = function () {
							var _p4 = justFinished;
							if (_p4 === true) {
								return {ctor: '[]'};
							} else {
								return model.points;
				...
				var newPoints = _p1._0;
				var newAnimation = _p1._1;
				var newAnimations = _p1._2;
				var newClock = model.clock + _p0._0;
				var _p5 = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(model.keyboardState);
				var x = _p5.x;
				var y = _p5.y;
				var newX = model.x + x;
				var newY = model.y + y;
				var newPoints_ = function () {
					...
					if (((_p6.ctor === '_Tuple2') && (_p6._0 === 0)) && (_p6._1 === 0)) {
						...
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: newX, _1: newY},
							_1: newPoints
						};
					}
				}();
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{points: newPoints_, clock: newClock, animation: newAnimation, animations: newAnimations});
				var _p7 = {ctor: '_Tuple2', _0: x, _1: y};
				if (((_p7.ctor === '_Tuple2') && (_p7._0 === 0)) && (_p7._1 === 0)) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model_,
						{ctor: '[]'});
			...
			case 'Shake':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{animations: _user$project$Main$animations}),
					{ctor: '[]'});
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$drawLine = F2(
	function (points, color) {
		var intsToFloats = function (_p8) {
			var _p9 = _p8;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(_p9._0),
				_1: _elm_lang$core$Basics$toFloat(_p9._1)
			};
		};
...
var _user$project$Main$initialModel = function () {
	var keyboardState = _ohanhi$keyboard_extra$Keyboard_Extra$initialState;
	return {
		ctor: '_Tuple2',
		_0: {
			points: {
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {points: a, x: b, y: c, color: d, keyboardState: e, clock: f, animation: g, animations: h};
	});
var _user$project$Main$ChangeColor = function (a) {
	return {ctor: 'ChangeColor', _0: a};
};
var _user$project$Main$colorButton = F2(
	function (color, name) {
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$ChangeColor(color)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$Shake = {ctor: 'Shake'};
var _user$project$Main$shakeButton = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$Shake),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Main$view = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('etch-a-sketch'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Etch-A-Sketch'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Use the arrow keys to draw something'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('artboard'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
								...
								A3(
									...
									400,
									{
										...
										_0: A2(
											...
											A2(_user$project$Main$drawLine, model.points, model.color)),
										_1: {ctor: '[]'}
									})),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('control-left'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Line Color: '),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Main$colorButton, _elm_lang$core$Color$red, 'Red'),
											_1: {
												ctor: '::',
												_0: A2(_user$project$Main$colorButton, _elm_lang$core$Color$blue, 'Blue'),
												_1: {
													ctor: '::',
													_0: A2(_user$project$Main$colorButton, _elm_lang$core$Color$green, 'Green'),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('control-right'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _user$project$Main$shakeButton,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
